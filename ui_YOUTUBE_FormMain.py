...
class Ui_FormMainWindow(object):
    def setupUi(self, FormMainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.ScrollAreaR.sizePolicy().hasHeightForWidth())
        self.ScrollAreaR.setSizePolicy(sizePolicy1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 438, 870))
